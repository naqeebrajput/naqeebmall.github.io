...
<table><table><table><table>
    ...
    <div id="container" style="width:99.5%; background: none; box-shadow: none; margin: 0.5% auto">
      ...
      <!-- product box -->
      <div class='box photo col2'> <a href="pstock-s5.php"><img src='../picture/images (13).jpg' alt=""></a>
        <p>jams </p>
        <p style='text-align:center; margin-bottom:12px'> <a href='pstock-s.php' class='button small secondary round'></a> </p>
      </div>
      <!-- product box -->
      <div class='box photo col2'> <a href="pstock-s6.php"><img src='../picture/images (8).jpg' alt=""></a>
        <p> Refreshments </p>
        <p style='text-align:center; margin-bottom:12px'> <a href='pstock-s.phpl' class='button small secondary round'></a> </p>
      </div>
      <!-- product box -->
      <div class='box photo col2'> <a href="pstock-s7.php"><img src='../picture/040118-grocerycp-imageheadlineblock-bbqcookout-2.jpg' alt=""></a>
        <p> cleaners </p>
        <p style='text-align:center; margin-bottom:12px'> <a href='pstock-s.php' class='button small secondary round'></a> </p>
		<td><a href="uu.php"/><input type="button" name="back"/></td>
      </div>
    </div>
