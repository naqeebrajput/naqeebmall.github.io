<marquee onmouseover="this.stop()" onmouseout="this.start()"><font color="#660000" ><h4>SUPPLIER edit OF GROCERY SHOP MANAGEMENT SYSTEM</h4></marquee>
<?php
include('header.php');
?>
<?php
...
<form action="sup-update.php" method="post" name="form1"onsubmit="return validate()">
...
<tr>
<td>company</td>
<td><input type="text"name="am"  value="<?php echo $row['company'];?>" />
</td>
</tr>
 <tr>
    <td>city</td>
