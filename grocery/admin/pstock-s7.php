...
<head>
<title>High Fashion | Product Single</title>
<meta charset="utf-8">
...
<table>
    <!-- END Header -->
    <div class="row">
      <div class="six columns"> <img src='../picture/040118-grocerycp-imageheadlineblock-bbqcookout-2.jpg' alt=""> </div>
      <div class="six columns">
        <div class="panel">
		  ...
		  <label><strong>cleaners</strong></label>
         
            <p></p>
            <label><strong>prices</strong></label>
            <input name="width" id="price" value="200" class="" type="text">
