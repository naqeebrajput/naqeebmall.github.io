<head>
<marquee onmouseover="this.stop()" onmouseout="this.start()"><font color="#660000" ><h4>REGISTER OF GROCERY SHOP MANAGEMENT SYSTEM</h4></marquee>
<?php
include('header.php');
?>
<head>
...
<form action="reg_insert.php" method="post" name="form1"onsubmit="return validate()">
<?php 
session_start();
if(isset($_SESSION['a']))
{
