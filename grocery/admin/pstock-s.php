...
include('header.php');
?>
<form action="cart_insert.php" method="post" name="form1"onsubmit="return validate()">
<table><table><table><table>
<table>
    <!-- END Header -->
    <div class="row">
      <div class="six columns"> <img src='../picture/New folder/6.PNG'" alt=""> </div>
      <div class="six columns">
        <div class="panel">
		  ...
		  <select><option>colifoller</option></select>
