...
<table>
    <!-- END Header -->
    <div class="row">
      <div class="six columns"> <img src='../picture/Nestle-Cerelac-Wheat-grocery-online.jpg' alt=""> </div>
      <div class="six columns">
        <div class="panel">
		  ...
		  <label><strong>cirilakes</strong></label>
         
            <p></p>
            <label><strong>prices</strong></label>
            <input name="width" id="price" value="100" class="" type="text">
            <p></p>
