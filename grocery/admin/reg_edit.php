<marquee onmouseover="this.stop()" onmouseout="this.start()"><font color="#660000" ><h4> register edit OF GROCERY SHOP MANAGEMENT SYSTEM</h4></marquee>
<?php
include('header.php');
?>
<?php
...
<form action="reg_update.php" method="post" name="form1"onsubmit="return validate()">
